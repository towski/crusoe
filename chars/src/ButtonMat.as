package
{
	...
	public class ButtonMat extends Sprite
	{
		...
		private var spriteWidth:Number = 8;
		private var spriteHeight:Number = 8;	
		private var spriteCount:int = 512;
		...
		{
			var rowLength:int = int(sheet.width / 8);
			var zone:int = int(this.mouseX / 8) + (int(this.mouseY / 8) * rowLength);
